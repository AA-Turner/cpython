...
:Editor: Adam Turner and Hugo van Kemenade
...
The biggest changes include template strings (:pep:`750`),
...
* :pep:`649` and :pep:`749`: :ref:`deferred evaluation of annotations <whatsnew314-deferred-annotations>`
* :pep:`750`: :ref:`Template strings <whatsnew314-template-string-literals>`
* :pep:`758`: :ref:`Allow except and except* expressions without parentheses <whatsnew314-bracketless-except>`
* :ref:`Free-threaded mode improvements <whatsnew314-free-threaded-cpython>`
* :pep:`765`: :ref:`Disallow return/break/continue that exit a finally block <whatsnew314-finally-syntaxwarning>`
* :pep:`768`: :ref:`Safe external debugger interface for CPython <whatsnew314-remote-debugging>`
* :ref:`A new type of interpreter <whatsnew314-tail-call>`
* :ref:`Improved error messages <whatsnew314-improved-error-messages>`

Significant improvements in the standard library:

* :pep:`734`: :ref:`Multiple interpreters in the stdlib <whatsnew314-multiple-interpreters>`
* :pep:`784`: :ref:`Adding Zstandard to the standard library <whatsnew314-zstandard>`
...
* The compression package? :ref:`whatsnew314-zstandard`
* PDB supports remote attach :ref:`whatsnew314-remote-pdb`
* :ref:`whatsnew314-asyncio-introspection`
* :ref:`whatsnew314-concurrent-warnings-control`
* :ref:`whatsnew314-incremental-gc`
...
* :pep:`779`: :ref:`Free-threaded Python is officially supported <whatsnew314-free-threaded-not-experimental>`
...
.. TODO: Sort in line with the summary above.


.. _whatsnew314-free-threaded-not-experimental:
...
This is the start of `phase II`_ where free-threaded Python is officially supported
but still optional.
...
Any decision to transition to `phase III`_, with free-threading as the default or
...
.. _phase II: https://discuss.python.org/t/37075
.. _phase III: https://discuss.python.org/t/37075
...
brackets to be omitted when there are multiple exception types and the ``as`` clause is not used.
...
and a geometric mean of 3-5% faster on ``pyperformance`` depending on platform and architecture. The
...
* :mod:`configparser` will no longer write config files it cannot read,
  to improve security.
  Attempting to :meth:`configparser.ConfigParser.write` keys containing delimiters or
...
* Support context manager protocol in :class:`contextvars.Token`.
...
* :class:`types.UnionType` and :class:`typing.Union` are now aliases for each other,
  ...
  - Both syntaxes for creating a union now produce the same string representation in
    :func:`repr`. For example, ``repr(Union[int, str])``
